...
APP_PARTS_DIR = "/data/data/network.loki.messenger/app_parts/"
LOCAL_MMS_DIR = "mms_files"
LOCAL_EXTRA_DIR = "extracted_files"


EXTRACTION_TARGETS = {
    "preferences": "/data/data/network.loki.messenger/shared_prefs/network.loki.messenger_preferences.xml",
    "signal_db": "/data/data/network.loki.messenger/databases/session.db",
